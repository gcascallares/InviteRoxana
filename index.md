...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="mini.jpg" />
    ...
    />
    <meta name="twitter:image" content="mini.jpg" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta itemprop="image" content="mini.jpg" />
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="detail-box">
                      <h1>Este año una Diosa Cumpleaños!</h1>
                      <h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="box">
              <div class="img-box">
                <img src="images/food-and-restaurant.png" alt="" />
              </div>
              <div class="detail-box">
                <h5>Comida</h5>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="box">
              <div class="img-box">
                <img src="images/notas-musicales.png" alt="" />
              </div>
              <div class="detail-box">
                <h5>Musica</h5>
